    ...
    boolean node2 = false;
     ...
     //Establishing communication & creating socket connection
        try {
                ...
                System.out.println("node1 is connected");
                
                
                node2Socket = server.accept();
                nodeSockets.add(node2Socket);
                connections++;
                System.out.println("node2 is connected");
              ...
              //ask for client id
                ...
                while(true){
                    ...
                    if(json.getString("type").equals("IDresponse")) {
                        ...
                        json.put("data", "How can I help today: \n1) credit or 2) pay-back. please spell as diplayed");
                        sout = new PrintWriter(clientSocket.getOutputStream(), true);
                        sout.println(json.toString());
...
public static void receiveFromNodes() {
    ...
    try {
        ...
        System.out.println("System did not receive data...");
    } 
