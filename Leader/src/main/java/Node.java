...
public class Node {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            System.out.println("Node is Connected to Leader<<<");
            
            
            
            System.out.println("Money balance for node is: " + money);
            try {
            while(true) {
       ...
       //===============================================================
                ...
                System.out.println("Connected. Please continue...");
    ...
    public static void submitCreditRequest(int amountToCredit,String name) {
        ...
        if(money < 0) {
            money = 0;
            System.out.println("not enough money left for this node");
            return;
        }
